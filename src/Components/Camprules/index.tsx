...
const text =
  "1. Alkohol eller andre rusmidler hører ikke hjemme i 4H. Det er forbudt å oppbevare og/eller nyte alkohol og andre rusmidler. Tobakk inkl. snus, samt energidrikker er ikke tillatt.\n" +
